...
import { MapPin, Phone, Clock, Car, User, Hash, Building, Tools } from 'lucide-react';
...
const ServiceSummary: React.FC<ServiceSummaryProps> = ({ requestData }) => {
  const centers = [
    {
      id: 1,
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">מספר רכב</div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">שם הנהג</div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">מספר אישי</div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">יחידה</div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">סוג השירות</div>
                ...
                <div className="flex items-center gap-2">
                  <Car className="h-5 w-5 text-gray-500" />
                  <div>
                    <div className="text-sm text-gray-500">צמיגים לטיפול</div>
                ...
                {requestData.pkaNumber && (
                  <div className="flex items-center gap-2">
                    <Hash className="h-5 w-5 text-gray-500" />
                    <div>
                      <div className="text-sm text-gray-500">מספר פק"ע</div>
        ...
        <Card>
          ...
          <CardContent className="p-6">
            <div className="text-center mb-6">
              <div className="font-medium">מיקומך הנוכחי:</div>
              <div className="text-gray-600">רמת הגולן - כביש 92</div>
            </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{center.distance} ק״מ ממיקומך</div>
                      </div>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>שעות פעילות: {center.hours}</span>
                      </div>
                    </div>
